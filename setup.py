...
setup(
    name="injection_noise_watermark",
    version="0.2.0",
    description="Injection Noise Watermark: Invisible watermark injection for diffusion models",
    long_description=open("README.md", "r", encoding="utf-8").read(),
    long_description_content_type="text/markdown",
    keywords="watermarking diffusion deep learning",
    license="MIT",
    author="Park Seong-Woo",
    author_email="seongwoo@aimz.media",
    url="https://github.com/YOUR_USERNAME/injection-noise-watermark",
    package_dir={"": "src"},
